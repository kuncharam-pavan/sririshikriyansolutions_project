...
export const Home = () => {
  const { matchedCount, recentlyViewed } = useProperties();
  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-50 dark:bg-slate-950 transition-colors">
      ...
      {/* 2. Main Marketplace Listings Section */}
      <section id="properties" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 w-full flex-grow">
        ...
        {/* 4. Why Choose Haven Section */}
        <div id="about" className="mt-24 bg-gradient-to-br from-indigo-900 to-slate-900 text-white rounded-3xl p-8 sm:p-12 shadow-2xl relative overflow-hidden">
